import { Calculator } from "../src/calculator";
 ...
 describe("Mocha Calculator Test", () => {
   ...
   it("Correctly finds the result of multiplication of two positive numbers", () => {
   ...
   it("Correctly finds the result of multiplication of positive and negative numbers", () => {
